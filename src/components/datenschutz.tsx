  ...
  render() {
    return (
      <div>
        ...
        <h2>Datenschutz</h2>
Wir haben diese Datenschutzerklärung (Fassung 15.09.2019-311116017) verfasst, um Ihnen gemäß der Vorgaben der <a href="https://eur-lex.europa.eu/legal-content/DE/ALL/?tid=1234&amp;uri=celex%3A32016R0679&amp;tid=311116017" target="_blank" rel="noopener noreferrer">Datenschutz-Grundverordnung (EU) 2016/679</a> zu erklären, welche Informationen wir sammeln, wie wir Daten verwenden und welche Entscheidungsmöglichkeiten Sie als Besucher dieser Webseite haben.
...
<div>
 	<div>die Adresse (URL) der aufgerufenen Webseite</div>
 	<div>Browser und Browserversion</div>
 	<div>das verwendete Betriebssystem</div>
 	<div>die Adresse (URL) der zuvor besuchten Seite (Referrer URL)</div>
 	<div>den Hostname und die IP-Adresse des Geräts von welchem aus zugegriffen wird</div>
 	<div>Datum und Uhrzeit</div>
</div>
in Dateien (Webserver-Logfiles).

In der Regel werden Webserver-Logfiles zwei Wochen gespeichert und danach automatisch gelöscht. Wir geben diese Daten nicht weiter, können jedoch nicht ausschließen, dass diese Daten beim Vorliegen von rechtswidrigem Verhalten eingesehen werden.
Die Rechtsgrundlage besteht nach <a href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&amp;tid=311116017" target="_blank" rel="noopener noreferrer">Artikel 6  Absatz 1 f DSGVO</a> (Rechtmäßigkeit der Verarbeitung) darin, dass berechtigtes Interesse daran besteht, den fehlerfreien Betrieb dieser Webseite durch das Erfassen von Webserver-Logfiles zu ermöglichen.
<h2>Cookies</h2>
...
<div>
 	...
 	<div>Beispielhafter Wert: GA1.2.1326744211.152311116017</div>
</div>
...
<a href="https://support.google.com/chrome/answer/95647?tid=311116017" target="_blank" rel="noopener noreferrer">Chrome: Cookies in Chrome löschen, aktivieren und verwalten</a>

<a href="https://support.apple.com/de-at/guide/safari/sfri11471/mac?tid=311116017" target="_blank" rel="noopener noreferrer">Safari: Verwalten von Cookies und Websitedaten mit Safari</a>

<a href="https://support.mozilla.org/de/kb/cookies-und-website-daten-in-firefox-loschen?tid=311116017" target="_blank" rel="noopener noreferrer">Firefox: Cookies löschen, um Daten zu entfernen, die Websites auf Ihrem Computer abgelegt haben</a>

<a href="https://support.microsoft.com/de-at/help/17442/windows-internet-explorer-delete-manage-cookies?tid=311116017" target="_blank" rel="noopener noreferrer">Internet Explorer: Löschen und Verwalten von Cookies</a>

<a href="https://support.microsoft.com/de-at/help/4027947/windows-delete-cookies?tid=311116017" target="_blank" rel="noopener noreferrer">Microsoft Edge: Löschen und Verwalten von Cookies</a>
...
<div>
 	<div>Recht auf Berichtigung (Artikel 16 DSGVO)</div>
 	<div>Recht auf Löschung („Recht auf Vergessenwerden“) (Artikel 17 DSGVO)</div>
 	<div>Recht auf Einschränkung der Verarbeitung (Artikel 18 DSGVO)</div>
 	<div>Recht auf Benachrichtigung – Mitteilungspflicht im Zusammenhang mit der Berichtigung oder Löschung personenbezogener Daten oder der Einschränkung der Verarbeitung (Artikel 19 DSGVO)</div>
 	<div>Recht auf Datenübertragbarkeit (Artikel 20 DSGVO)</div>
 	<div>Widerspruchsrecht (Artikel 21 DSGVO)</div>
 	<div>Recht, nicht einer ausschließlich auf einer automatisierten Verarbeitung — einschließlich Profiling — beruhenden Entscheidung unterworfen zu werden (Artikel 22 DSGVO)</div>
</div>
Wenn Sie glauben, dass die Verarbeitung Ihrer Daten gegen das Datenschutzrecht verstößt oder Ihre datenschutzrechtlichen Ansprüche sonst in einer Weise verletzt worden sind, können Sie sich an die <a href="https://www.bfdi.bund.de/DE/Datenschutz/Ueberblick/MeineRechte/Artikel/BeschwerdeBeiDatenschutzbehoereden.html?tid=311116017" target="_blank" rel="noopener noreferrer">Bundesbeauftragte für den Datenschutz und die Informationsfreiheit (BfDI)</a> wenden.
...
<strong >Ablaufzeit:</strong> nach 3 Monaten
<strong >Beispielwert:</strong> EhMI_aySuoyv4gIVled3Ch0llweVGAEgt-mr6aXd7dYlSAGQ311116017

<strong >Name:</strong> _gac
<strong >Ablaufzeit:</strong> nach 3 Monaten
<strong >Beispielwert:</strong> 1.1558695989.EAIaIQobChMIiOmEgYO04gIVj5AYCh2CBAPrEAAYASAAEgIYQfD_BwE
...
Falls Sie grundsätzlich keine Cookies haben wollen, können Sie Ihren Browser so einrichten, dass er Sie immer informiert, wenn ein Cookie gesetzt werden soll. So können Sie bei jedem einzelnen Cookie entscheiden, ob Sie das Cookie erlauben oder nicht. Durch das Herunterladen und Installieren dieses Browser-Plug-ins auf <a href="https://support.google.com/ads/answer/7395996" target="_blank" rel="noopener noreferrer">https://support.google.com/ads/answer/7395996</a> werden ebenfalls alle „Werbecookies“ deaktiviert. Bedenken Sie, dass Sie durch das Deaktivieren dieser Cookies nicht die Werbeanzeigen verhindern, sondern nur die personalisierte Werbung.

Durch die Zertifizierung für das amerikanische-europäische Datenschutzübereinkommen “Privacy Shield”, muss der amerikanische Konzern Google LLC die in der EU geltenden Datenschutzgesetze einhalten. Wenn Sie Näheres über den Datenschutz bei Google erfahren möchten, empfehlen wir die allgemeine Datenschutzerklärung von Google: <a href="https://policies.google.com/privacy?hl=de" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy?hl=de</a>.
...
Google Fonts (früher Google Web Fonts) ist ein interaktives Verzeichnis mit mehr als 800 Schriftarten, die die <a href="https://de.wikipedia.org/wiki/Google_LLC?tid=311116017" target="_blank" rel="noopener noreferrer">Google LLC</a> zur freien Verwendung bereitstellt.
...
<h3>Wie kann ich meine Daten löschen bzw. die Datenspeicherung verhindern?</h3>
Jene Daten, die Google für einen Tag bzw. ein Jahr speichert können nicht einfach gelöscht werden. Die Daten werden beim Seitenaufruf automatisch an Google übermittelt. Um diese Daten vorzeitig löschen zu können, müssen Sie den Google-Support auf <a href="https://support.google.com/?hl=de&amp;tid=311116017" target="_blank" rel="noopener noreferrer">https://support.google.com/?hl=de&amp;tid=311116017</a> kontaktieren. Datenspeicherung verhindern Sie in diesem Fall nur, wenn Sie unsere Seite nicht besuchen.

Anders als andere Web-Schriften erlaubt uns Google uneingeschränkten Zugriff auf alle Schriftarten. Wir können also unlimitiert auf ein Meer an Schriftarten zugreifen und so das Optimum für unsere Webseite rausholen. Mehr zu Google Fonts und weiteren Fragen finden Sie auf <a href="https://developers.google.com/fonts/faq?tid=311116017" target="_blank" rel="noopener noreferrer">https://developers.google.com/fonts/faq?tid=311116017</a>. Dort geht zwar Google auf datenschutzrelevante Angelegenheiten ein, doch wirklich detaillierte Informationen über Datenspeicherung sind nicht enthalten. Es ist relativ schwierig (beinahe unmöglich), von Google wirklich präzise Informationen über gespeicherten Daten zu bekommen.

Welche Daten grundsätzlich von Google erfasst werden und wofür diese Daten verwendet werden, können Sie auch auf <a href="https://policies.google.com/privacy?hl=de&amp;tid=311116017" target="_blank" rel="noopener noreferrer">https://www.google.com/intl/de/policies/privacy/</a> nachlesen.
...
<div>
 	...
 	<div>_gid
<div>
 	<div>Ablaufzeit: 24 Stunden</div>
 	<div>Verwendung: Unterscheidung der Webseitenbesucher</div>
 	<div>Beispielhafter Wert: GA1.2.1687193234.152311116017</div>
</div>
</div>
 	<div>_gat_gtag_UA_&lt;property-id&gt;
<div>
 	<div>Ablaufzeit: 1 Minute</div>
 	<div>Verwendung: Wird zum Drosseln der Anforderungsrate verwendet. Wenn Google Analytics über den Google Tag Manager bereitgestellt wird, erhält dieser Cookie den Namen _dc_gtm_ &lt;property-id&gt;.</div>
 	<div>Beispielhafter Wert: 1</div>
</div>
</div>
</div>
...
Mithilfe des <strong >Browser-Add-ons zur Deaktivierung</strong> von Google Analytics-JavaScript (ga.js, analytics.js, dc.js) können Website-Besucher verhindern, dass Google Analytics ihre Daten verwendet.
...
Die Datenschutzrichtlinien, welche Informationen XING sammelt und wie sie diese verwenden finden Sie auf <a href="https://www.xing.com/privacy">https://www.xing.com/privacy</a>.
