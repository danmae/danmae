    ...
    return (
          ...
          <div className={`${styles.introText}`}>
            ...
            <div className={`${styles.downloadButtons}`}>
              <div className={`${styles.downloadButton1}`}>
                <a href="/uploads/cv-ger.pdf"><button className={`${styles.about}`}><img src="images/icons/download.png" className={`${styles.downloadImage}`} width="20px"/>Lebenslauf</button></a>
              </div>
              <div className={`${styles.downloadButton2}`}>
                <a href="https://www.linkedin.com/in/daniel-maelzer-3934541a7/details/certifications/"><button className={`${styles.portfolio}`}><img src="images/icons/download.png" className={`${styles.downloadImage}`} width="20px"/>Zertifikate</button></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={`${styles.servicesSection}`}>
        <div className={`${styles.wordpress}`}>
          <img className={`${styles.serviceIcon}`} src="images/services/wordpress-logo.png"/>
        ...
        <div className={`${styles.seo}`}>
          <img className={`${styles.serviceIcon}`} src="images/services/analysis.png"/>
        ...
        <div className={`${styles.maintenance}`}>
          <img className={`${styles.serviceIcon}`} src="images/services/tools.png"/>
        ...
        <div className={`${styles.hosting}`}>
          <img className={`${styles.serviceIcon}`} src="images/services/database.png"/>
